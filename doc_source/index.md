...
+ [Setting up the AWS Tools for Windows PowerShell or AWS Tools for PowerShell Core](pstools-getting-set-up.md)
   + [Setting up the AWS Tools for PowerShell on a Windows-based Computer](pstools-getting-set-up-windows.md)
   + [Setting up the AWS Tools for PowerShell Core on Linux or macOS X](pstools-getting-set-up-linux-mac.md)
