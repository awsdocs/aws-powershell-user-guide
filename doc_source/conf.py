...
project = u'AWS Tools for Windows Powershell User Guide'
...
htmlhelp_basename = 'AWSPowershellUserGuide'
...
latex_documents = [
  (master_doc, 'AWSPowershellUserGuide.tex', project,
   author, 'manual'),
]
...
man_pages = [
    (master_doc, 'awspowershelluserguide', project,
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'AWSPowershellUserGuide', project,
   author, 'AWSPowershellUserGuide', 'One line description of project.',
   'Miscellaneous'),
]
